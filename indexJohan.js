...
var turnLabel = document.getElementById("turn_player");
...
// if (player1.shipCount === 0) {
  ...
  function ev (e, pl) {
    ...
    disparar((pl === "player2" ? player1 : player2),x,y)//player 1 shot player2 in her board
...
//   console.log ('entro create boards');
//   for (var x = 0; x < 4; x++) {
//       const li = document.createElement('li'); // creating childs for the list (board), in this case represent a row number 'x' of the board
//       for (var y = 0; y < 4; y++) {
//         const cell = document.createElement('div');
...
//               gameWinner();//Function to display the winner
//               refreshPage()//Function to refresh the page
//             }
//         });
//         li.appendChild(cell); //adding each cell into the row number x
//       }
...
//         currentplayer = player2;//Change turn
//         opponent = player1;
//         player = currentplayer.name;
//         livesp1 = player1.shipCount;
//         livesp2 = player2.shipCount;
...
//         document.getElementById("ships_player2").textContent = livesp2;
//         if ((player1.shipCount === 0) || (player2.shipCount === 0)){
//             gameWinner();//Function to find the winner
//             refreshPage();//Function to play again
//         }
//       });
//       li.appendChild(cell); //adding each cell into the row number x
//     }
